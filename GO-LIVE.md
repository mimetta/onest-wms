...
| S8 | **Wipe the demo seed from the hosted project before real data lands** | The hosted database was seeded on 2026-08-11 so the deployed app was usable on a phone. Those 50 SKUs and 8 accounts are demo data, and D1 below covers removing them. | ☐ |
